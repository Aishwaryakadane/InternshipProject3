...
class User {
 ...
 public class ATM {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("Welcome to the ATM! CANARA BANK");
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    System.out.println("Your balance is: Rs" + currentUser.getAccount().getBalance());
                    break;
                ...
                case 5:
                    ...
                    for (Transaction transaction : transactions) {
                        System.out.println("Date: " + transaction.getTimestamp() + ", Amount: Rs" + transaction.getAmount());
                    }
                    break;
